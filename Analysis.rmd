...
plot_data_revised <- plot_data(weekly_truth_revised, daily_truth_revised)
plot_data <- plot_data(weekly_truth, daily_truth)

ggsave("output/figures/plot-data-revised.png", plot = plot_data_revised, 
       width = 7, height = 5)

ggsave("output/figures/plot-data.png", plot = plot_data, 
       width = 7, height = 3.5)
...
plot_weekly_revisions <- weekly_truth |>
  ...
  labs(y = "Difference in data", x = "Date") + 
  coord_cartesian(ylim = c(-500, 500)) + 
  theme_scoringutils()

ggsave("output/figures/data-revisions.png", plot = plot_weekly_revisions, 
       width = 7, height = 2.5)
