...
On the natural scale, the Forecast Hub ensemble was slightly ahead of the crowd forecasts, with the difference gradually increasing with increasing forecast horizon (see Figure \ref{fig:performance}). On the log scale, the Forecast Hub ensemble was slightly worse than all crowd forecasting approaches at a two week forecast horizon, but again slightly ahead for forecasts four weeks into the future. 
...
On the natural scale, direct forecasts had a slightly better WIS than the Hub ensemble and the other two human forecast ensembles for a two-week-ahead horizon, while the Hub ensemble was again slightly ahead for a four week-ahead horizon (see Figure \ref{fig:performance}). The combined crowd forecast (containing both the direct and the $R_t$ forecasts) overall performed slightly worse than the direct crowd forecast on the natural scale, but much better than the $R_t$ forecasts. On the log scale, the combined crowd forecasts even performed best among the four approaches. 
